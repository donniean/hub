...
head_branch_name="chore/refresh-pnpm-state-${timestamp}"
commit_message="chore: refresh pnpm lockfile and build approvals"
...
for repo_name in "${repo_names[@]}"; do
  ...
  (
    ...
    pr_url="$(gh pr create \
      ...
      --body "Regenerate the pnpm lockfile, reset build approvals for the current install environment, and approve all discovered pending builds. Generated by \`scripts/update/pnpm-refresh.sh\`.")"
