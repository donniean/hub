...
echo 'cd ${ZSH_CUSTOM:=~/.oh-my-zsh/custom}/plugins/zsh-autosuggestions && git pull'
cd ${ZSH_CUSTOM:=~/.oh-my-zsh/custom}/plugins/zsh-autosuggestions && git pull

echo 'cd ${ZSH_CUSTOM:=~/.oh-my-zsh/custom}/plugins/zsh-syntax-highlighting && git pull'
cd ${ZSH_CUSTOM:=~/.oh-my-zsh/custom}/plugins/zsh-syntax-highlighting && git pull

echo 'cd ${ZSH_CUSTOM:=~/.oh-my-zsh/custom}/plugins/zsh-better-npm-completion && git pull'
